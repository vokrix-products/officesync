...
export const statuses: {
  ...
  { label: 'Available', value: 'available:good', icon: CircleCheckBig, severity: 'good' as Severity },
  ...
  { label: 'No Show', value: 'no_show:critical', icon: TriangleAlert, severity: 'critical' as Severity },
  ...
  { label: 'Maintenance Cleaning', value: 'maintenance_cleaning:warning', icon: Clock, severity: 'warning' as Severity },
  { label: 'Over Capacity', value: 'over_capacity:critical', icon: TriangleAlert, severity: 'critical' as Severity },
]
